      ...
      skills: [
        {
          id: "jira",
          name: "Jira",
          description: "Issue tracking, Scrum/Kanban boards, roadmaps with strong workflow and DevOps integration",
        },
        {
          id: "linear",
          name: "Linear",
          description: "Fast issue tracking with powerful shortcuts and seamless GitHub and pull request integration",
        },
        {
          id: "asana",
          name: "Asana",
          description: "Project management with timelines, dependencies, and goal tracking capabilities",
        },
        { id: "trello", name: "Trello", description: "Lightweight Kanban boards with flexibility for small teams and individuals" },
        { id: "clickup", name: "ClickUp", description: "All-in-one platform combining tasks, docs, goals, sprints, and dashboards" },
        {
          id: "notion",
          name: "Notion",
          description: "Combines documentation, database, and Kanban features for PRDs, specs, and task tracking",
        },
        {
          id: "azure-boards",
          name: "Azure Boards",
          description: "Backlog and sprint management integrated with Azure Repos and Pipelines",
        },
        {
          id: "github-projects",
          name: "GitHub Projects",
          description: "Boards and tables directly linked to GitHub Issues and pull requests with workflow automation",
        },
      ],
    },
  ]
